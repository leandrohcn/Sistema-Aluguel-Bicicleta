...
public class FuncionarioService {
    ...
    public FuncionarioEntity addFuncionario(NovoFuncionarioDTO funcionarioDTO) {
    ...
    public ResponseEntity<FuncionarioEntity> atualizaFuncionario(NovoFuncionarioDTO funcionarioDTO,
                                                                 Long idFuncionario) {
